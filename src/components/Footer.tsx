  ...
  const COLS = [
    {
      title: t("nav.pharma"),
      items: [
        { label: t("pages.pharma.areas.essential.title"), to: "/solutions/pharma" },
        { label: t("pages.pharma.areas.biologics.title"), to: "/solutions/pharma" },
        { label: t("pages.pharma.areas.specialty.title"), to: "/solutions/pharma" },
        { label: t("pages.pharma.areas.maternal.title"), to: "/solutions/pharma" },
      ],
    },
    {
      title: t("nav.healthtech"),
      items: [
        { label: t("pages.healthtech.modalities.imaging.title"), to: "/solutions/healthtech" },
        { label: t("pages.healthtech.modalities.ivd.title"), to: "/solutions/healthtech" },
        { label: t("pages.healthtech.modalities.surgical.title"), to: "/solutions/healthtech" },
        { label: t("pages.healthtech.modalities.his.title"), to: "/solutions/healthtech" },
      ],
    },
    {
      title: t("nav.about"),
            ...
            {COLS.map((col) => (
              <div key={col.title}>
                ...
                <ul className="space-y-3 text-sm text-parchment/70">
                  {col.items.map((it) => (
                    <li key={it.label}>
                      <Link to={it.to} className="transition-colors hover:text-saffron">
                        {it.label}
                      </Link>
                    </li>
                  ))}
