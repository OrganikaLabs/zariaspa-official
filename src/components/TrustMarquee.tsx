...
export function TrustMarquee({ title }: { title?: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto mb-8 max-w-7xl px-6 md:px-10">
        <p className="text-[10px] font-bold tracking-[0.4em] text-ink-soft uppercase">
          {title || t("trust.eyebrow")}
        </p>
      </div>
